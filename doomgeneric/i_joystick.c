...
void I_InitJoystick(void)
{
    ...
    {
        mre_printf("I_InitJoystick: Invalid joystick ID: %i\n", joystick_index);
        SDL_QuitSubSystem(SDL_INIT_JOYSTICK);
        return;
    }
    ...
    if (joystick == NULL)
    {
        mre_printf("I_InitJoystick: Failed to open joystick #%i\n",
               joystick_index);
        SDL_QuitSubSystem(SDL_INIT_JOYSTICK);
        return;
    }
    ...
    {
        mre_printf("I_InitJoystick: Invalid joystick axis for joystick #%i "
