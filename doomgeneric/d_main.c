...
void D_DoomLoop (void)
{
    ...
    {
        mre_printf(" WARNING: You are playing using one of the Doom Classic\n"
...
static char *GetGameName(char *gamename)
{
    ...
    for (i=0; i<arrlen(banners); ++i)
    {
        ...
        if (deh_sub != banners[i])
        {
            ...
            // Has been replaced.
            // We need to expand via mre_printf to include the Doom version number
...
static void SetMissionForPackName(char *pack_name)
{
    ...
    mre_printf("Valid mission packs are:\n");
...
static void InitGameVersion(void)
{
    ...
    if (p)
    {
        ...
        {
            mre_printf("Supported game versions:\n");
...
void PrintGameVersion(void)
{
    ...
    for (i=0; gameversions[i].description != NULL; ++i)
    {
        ...
        {
            mre_printf("Emulating the behavior of the "
                   "'%s' executable.\n", gameversions[i].description);
            break;
        }
    }
...
void D_DoomMain (void)
{
    ...
    {
        mre_printf("Dedicated server mode.\n");
        NET_DedicatedServer();
    ...
    {
        mre_printf("BFG Edition: Using workarounds as needed.\n");
        bfgedition = true;
...
//    W_PrintDirectory();
    ...
    if (M_ParmExists("-dehlump"))
    {
        ...
        mre_printf("  loaded %i DEHACKED lumps from PWAD files.\n", loaded);
    }
#endif
    ...
    {
        I_PrintDivider();
        mre_printf(" WARNING: The loaded WAD file contains modified sprites or\n"
    ...
    {
        mre_printf(" WARNING: You are playing using one of the Freedoom IWAD\n"
...
#ifdef FEATURE_MULTIPLAYER
    mre_printf ("NET_Init: Init network subsystem.\n");
    NET_Init ();
#endif
