...
static boolean WriteTimidityConfig(char *path, gus_config_t *config)
{
    ...
    mre_fprintf(fstream, "# Autogenerated Timidity config.\n\n");

    mre_fprintf(fstream, "dir %s\n", gus_patch_path);
...
boolean GUS_WriteConfig(char *path)
{
    ...
    {
        mre_printf("You haven't configured gus_patch_path.\n");
        mre_printf("gus_patch_path needs to point to the location of "
               "your GUS patch set.\n"
