...
boolean W_ParseCommandLine(void)
{
    ...
    if (p > 0)
    {
        for (p = p + 1; p<myargc && myargv[p][0] != '-'; ++p)
        {
            ...
            mre_printf(" performing NWT-style merge of %s\n", filename);
    ...
    if (p > 0)
    {
        for (p = p + 1; p<myargc && myargv[p][0] != '-'; ++p)
        {
            ...
            mre_printf(" merging flats from %s\n", filename);
    ...
    if (p > 0)
    {
        for (p = p + 1; p<myargc && myargv[p][0] != '-'; ++p)
        {
            ...
            mre_printf(" merging sprites from %s\n", filename);
    ...
    if (p > 0)
    {
        for (p = p + 1; p<myargc && myargv[p][0] != '-'; ++p)
        {
            ...
            mre_printf(" merging sprites and flats from %s\n", filename);
